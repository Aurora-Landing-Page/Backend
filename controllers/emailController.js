...
const sendQRMail = async (name, email, image, code, receiptId) => {
  const subject = receiptId ? `Payment Intent Received: ${ receiptId }`: "Aurora Ticket";
  var mailOptions = {
    from: process.env.EMAIL,
    to: email,
    subject: subject,
...
const sendConfirmation = async (name, email, image, ticketCode, receiptId) => {
  var mailOptions = {
    from: process.env.EMAIL,
    to: email,
    subject: `Aurora 2024: Payment ${receiptId} confirmed`,
    html: `<!doctype html>
    <html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
...
module.exports = { sendSignupMail, sendSignupMailCa, sendForgotPassMail, sendQRMail, sendConfirmation };
