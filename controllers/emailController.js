...
const sendPhysicalMail = asyncHandler(async (name, email, ticketCode) => {
  var mailOptions = {
      from: process.env.EMAIL,
      to: email,
      subject: "Aurora 2024: Registration Done Successfully",
                                                                                          ...
                                                                                          <td width="560" 
                                                                                              ...
                                                                                              <table cellpadding="0"
                                                                                                  ...
                                                                                                  <tbody>
                                                                                                      ...
                                                                                                      <p>Keep an eye on your inbox for any updates or changes. More information will be emailed out soon along with a comprehensive itinerary of the events and sessions.</p>
                                                                                                      <p>If you have any questions or concerns leading up to the fest, feel free to reach out to our dedicated support team at support@aurorafest.in</p>
                                                                                                      <p>Your pass code is ${ticketCode}. <strong>Please note that you cannot be admitted to the event by showing this email. Please keep the physical pass on your person on all three days of the event.</strong></p>
                  ...
                  <div class="mj-column-per-100 mj-outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:middle;width:100%;">
                    <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:middle;" width="100%">
                      <tbody>
                        ...
                        <tr>
                          <td align="center" style="font-size:0px;padding:10px 25px;padding-right:25px;padding-left:25px;word-break:break-word;">
                            <div style="font-family:open Sans Helvetica, Arial, sans-serif;font-size:16px;line-height:1;text-align:center;color:white;">Your pass has been generated and is attached to this email. Please remember the following pass code in case you lose the pass:</div>
                          </td>
                        </tr>
                        <tr>
                          <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                        ...
                        <tr>
                          <td align="center" style="font-size:0px;padding:10px 25px;padding-right:16px;padding-left:25px;word-break:break-word;">
                            <div style="font-family:open Sans Helvetica, Arial, sans-serif;font-size:16px;line-height:1;text-align:center;color:white;">You can always regenerate the pass by logging in to the official site. Please ensure that you have the pass code or the pass on your person as it will be checked before entry to the event.</div>
                          </td>
                        </tr>
                        <tr>
                          <td align="center" style="font-size:0px;padding:10px 25px;padding-right:16px;padding-left:25px;word-break:break-word;">
                  ...
                  <div class="mj-column-per-100 mj-outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:middle;width:100%;">
                    <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:middle;" width="100%">
                      <tbody>
                        ...
                        <tr>
                          <td align="left" style="font-size:0px;padding:10px 25px;padding-right:25px;padding-left:25px;word-break:break-word;">
                            <div style="font-family:open Sans Helvetica, Arial, sans-serif;font-size:16px;line-height:1;text-align:left;color:white;">Your payment has been reviewed and approved. Your pass code for the event is:</div>
                          </td>
                        </tr>
                        <tr>
                          <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                  ...
                  <div class="mj-column-per-100 mj-outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:middle;width:100%;">
                    <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:middle;" width="100%">
                      <tbody>
                        ...
                        <tr>
                          <td align="left" style="font-size:0px;padding:10px 25px;padding-right:25px;padding-left:25px;word-break:break-word;">
                            <div style="font-family:open Sans Helvetica, Arial, sans-serif;font-size:16px;line-height:1;text-align:left;color:white;">Your payment has been reviewed and approved. Your participation is now confirmed for ${eventName }. Your pass code for the event is:</div>
                          </td>
                        </tr>
                        <tr>
                          <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
